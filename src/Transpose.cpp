...
TransposeWidget(Transpose *module){
   ...
   addParam(createParam<FlatASnap>(Vec(4, 15), module, Transpose::OCTAVE_SHIFT_1));
   addParam(createParam<FlatASnap>(Vec(4, 75), module, Transpose::OCTAVE_SHIFT_2));
   addParam(createParam<FlatASnap>(Vec(4, 135), module, Transpose::SEMITONE_SHIFT_1));
   addParam(createParam<FlatASnap>(Vec(4, 195), module, Transpose::SEMITONE_SHIFT_2));
   addParam(createParam<FlatA>(Vec(4, 255), module, Transpose::FINE_SHIFT_1));
   addParam(createParam<FlatA>(Vec(4, 315), module, Transpose::FINE_SHIFT_2));
