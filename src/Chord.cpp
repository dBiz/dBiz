...
int space = 40;
  ...
  addParam(createParam<Trimpot>(Vec(off*2,pot*1), module, Chord::OFFSET_AMT_PARAM, 0.0, 1.0, 0.0));
  addParam(createParam<Trimpot>(Vec(off*2,pot*2), module, Chord::INVERSION_AMT_PARAM, 0.0, 1.0, 0.0));
  addParam(createParam<Trimpot>(Vec(off*2,pot*3), module, Chord::VOICING_AMT_PARAM, 0.0, 1.0, 0.0));

  

  addParam(createParam<FlatG>(Vec(off + 30 ,space*1-15), module, Chord::OFFSET_PARAM, 0.0, 1.0, 0.5));
  addParam(createParam<FlatA>(Vec(off + 30 ,space*2-15), module, Chord::INVERSION_PARAM, 0.0, 1.0, 0.0));
  addParam(createParam<FlatR>(Vec(off + 30 ,space*3-15), module, Chord::VOICING_PARAM, 0.0, 1.0, 0.0));
...
//
  ...
  addParam(createParam<LEDB>(Vec(-22 + left, 3+ 180), module, Chord::FLAT_3RD_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + left, 3+ 180+jacks*1), module, Chord::FLAT_5TH_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + left, 3+ 180+jacks*2), module, Chord::FLAT_7TH_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + left, 3+ 180+jacks*3), module, Chord::SIX_FOR_7_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + left, 3+ 180+jacks*4), module, Chord::SHARP_5_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + right,3+  180), module, Chord::SUS_2_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + right,3+  180+jacks*1), module, Chord::SUS_4_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + right,3+  180+jacks*2), module, Chord::SIX_FOR_5_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + right,3+  180+jacks*3), module, Chord::ONE_FOR_7_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + right,3+  180+jacks*4), module, Chord::FLAT_9_PARAM,0.0,1.0,0.0));
  addParam(createParam<LEDB>(Vec(-22 + right,3+  180+jacks*5), module, Chord::SHARP_9_PARAM,0.0,1.0,0.0));
  ...
  addChild(createLight<TinyLight<RedLight>>(Vec(97+22,jacks*1),module, Chord::OUT_1_LIGHT));
  addChild(createLight<TinyLight<RedLight>>(Vec(97+22,jacks*2),module, Chord::OUT_1_LIGHT));
  addChild(createLight<TinyLight<RedLight>>(Vec(97+22,jacks*3),module, Chord::OUT_1_LIGHT));
  addChild(createLight<TinyLight<RedLight>>(Vec(97+22,jacks*4),module, Chord::OUT_1_LIGHT));
