...
MultiFilter *lpFilter = new MultiFilter() ;	// create a lpFilter;
MultiFilter *hpFilter = new MultiFilter() ;	// create a lpFilter;
MultiFilter *bpFilter = new MultiFilter() ;	// create a lpFilter;
MultiFilter *npFilter = new MultiFilter() ;	// create a lpFilter;

MultiFilter *lp2Filter = new MultiFilter(); // create a lpFilter;
MultiFilter *hp2Filter = new MultiFilter(); // create a lpFilter;
MultiFilter *bp2Filter = new MultiFilter(); // create a lpFilter;
MultiFilter *np2Filter = new MultiFilter(); // create a lpFilter;
...
//MultiFilter *peakFilter = new MultiFilter();
