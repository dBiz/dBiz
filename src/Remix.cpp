...
RemixWidget(Remix *module) : ModuleWidget(module)
{
    ...
    addInput(Port::create<PJ301MCPort>(Vec(mid +10 , 320), Port::INPUT, module, Remix::SLOPE_INPUT));
    ...
    addOutput(Port::create<PJ301MOPort>(Vec(board + 7.5, 20), Port::OUTPUT, module, Remix::A_OUTPUT));
    addInput(Port::create<PJ301MCPort>(Vec(board+7.5, 320), Port::INPUT, module, Remix::SCAN_INPUT));

    addOutput(Port::create<PJ301MOPort>(Vec(mid-15 + 7.5, 20), Port::OUTPUT, module, Remix::B_OUTPUT));
    addInput(Port::create<PJ301MCPort>(Vec(mid-15+ 7.5, 290), Port::INPUT, module, Remix::WIDTH_INPUT));

    addOutput(Port::create<PJ301MOPort>(Vec(box.size.x-knob-board + 7.5, 20), Port::OUTPUT, module, Remix::C_OUTPUT));
    addInput(Port::create<PJ301MCPort>(Vec(box.size.x-knob-board + 7.5, 320), Port::INPUT, module, Remix::LEVEL_INPUT));
